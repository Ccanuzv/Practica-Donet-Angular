    ...
    template: `
        <div class="layout-sidebar" [ngClass]="{ active: active }">
            <a [routerLink]="['/']" class="logo">
                <img alt="logo" [src]="'https://primefaces.org/cdn/primeng/images/' + (config.dark ? 'primeng-logo-light.svg' : 'primeng-logo-dark.svg')" height="41" />
            </a>
...
export class AppMenuComponent {
    ...
    //         label: 'File',
    //         value: 'fileupload',
    //         items: [{ label: 'Upload', value: '/fileupload' }]
    //     },
    //     {
    //         label: 'Menu',
    //         value: 'menu',
    ...
    //         label: 'DragDrop',
    //         value: 'dragdrop',
    //         items: [{ label: 'DragDrop', value: '/dragdrop' }]
    //     },
    //     {
    //         label: 'Misc',
    //         value: 'misc',
    ...
    //         label: 'Utilities',
    //         value: 'utilities',
    //         items: [{ label: 'FilterService', value: '/filterservice' }]
    //     }
    // ];
